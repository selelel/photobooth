      ...
      case 'single':
        return (
          <div className="w-full h-full bg-gray-200 rounded-lg flex items-center justify-center">
            {photos[0] ? (
              <div className="w-full h-full bg-blue-300 rounded-lg flex items-center justify-center text-white">
                Photo 1 ✓
              </div>
            ) : (
          ...
          <div className="w-full h-full bg-gray-200 rounded-lg p-2 flex flex-col gap-2">
            {photos.map((photo, i) => (
              <div key={i} className={`flex-1 rounded ${
                photo ? 'bg-blue-300 text-white' : 'bg-gray-300 text-gray-500'
  ...
  return (
    <div className="w-full h-full bg-black flex">
      ...
      <div className="flex-1 relative">
        {/* Mock Camera Feed */}
        <div className="w-full h-full bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 relative">
          {/* Camera placeholder */}
