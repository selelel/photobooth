...
export default function DashboardPage() {
  ...
  return (
    <>
      <CreateTemplateDialog open={createTemplateDialogOpen} onOpenChange={setCreateTemplateDialogOpen} />
        ...
        <main className="flex-1 p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <Button onClick={() => setCreateTemplateDialogOpen(true)} className="rounded-lg bg-black text-white hover:bg-gray-800">
                Create New Template
              </Button>
            </div>
